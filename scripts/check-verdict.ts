...
const ct = (await db.select().from(coutTravaux)).map((c) => ({ classeCible: c.classeCible, trancheSurface: c.trancheSurface, coutMedian: c.coutMedian!, coutP25: c.coutP25!, coutP75: c.coutP75!, n: c.n }))
